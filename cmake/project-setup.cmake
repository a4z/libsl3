...
message(STATUS
  "HERE WITH FILE INCLUDE_FETCH_DEPENDENCIE_FILE: ${INCLUDE_FETCH_DEPENDENCIE_FILE}"
)


if (INCLUDE_FETCH_DEPENDENCIE_FILE)
  message(STATUS "--- INCLUDE FILE ${INCLUDE_FETCH_DEPENDENCIE_FILE}")
  set(ACTIVATE_INCLUDE_FETCH_DEPENDENCIE_FILE ON)
  include(${INCLUDE_FETCH_DEPENDENCIE_FILE})
endif()
